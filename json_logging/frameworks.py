...
register_framework_support(
    "flask",
    None,
    flask_support.FlaskAppRequestInstrumentationConfigurator,
...
register_framework_support(
    "quart",
    None,
    quart_support.QuartAppRequestInstrumentationConfigurator,
...
register_framework_support(
    "connexion",
    None,
    connexion_support.ConnexionAppRequestInstrumentationConfigurator,
