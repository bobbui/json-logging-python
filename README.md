...
_For backwards compatibility, properties added in `props` take precedence over those set in the root of `extra`. This is relevant only for logs formatted by `JSONLogFormatter`, other formatters never printed the `props` details._
